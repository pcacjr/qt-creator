...
{
    Q_OBJECT
    friend class PythonBuildConfigurationFactory;

public:
    explicit PythonBuildConfiguration(PythonTarget *parent);
    virtual ~PythonBuildConfiguration();

    PythonTarget *pythonTarget() const;
...
protected:
    PythonBuildConfiguration(PythonTarget *parent, PythonBuildConfiguration *source);
    PythonBuildConfiguration(PythonTarget *parent, const QString &id);
...
class PythonBuildConfigurationFactory : public ProjectExplorer::IBuildConfigurationFactory
{
    Q_OBJECT

public:
    explicit PythonBuildConfigurationFactory(QObject *parent = 0);
    virtual ~PythonBuildConfigurationFactory();
